...
const About = () => {
  ...
  return (
    <div id="about" className="px-4 bg-blue-50">
      <div className="md:w-4/5 lg:w-2/3 mx-auto">
        ...
        <article className="text-xl">
          <p>
            Based in Manchester, my journey into the tech world really kicked off when I joined
          ...
          <p>
            ...
            GitHub. Let's connect and maybe build something together!
          </p>
        </article>
        <br />
